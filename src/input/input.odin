...
Key_Bindings :: struct {
	...
	dump_tree:    string,
	resize_mode:  string,
	fullscreen_toggle: string,
	layout_stacking: string,
	layout_tabbed: string,
	layout_toggle_split: string,
	focus_left:   string,
	focus_down:   string,
	focus_up:     string,
	focus_right:  string,
...
key_bindings_default :: proc() -> Key_Bindings {
	return Key_Bindings {
		...
		dump_tree = "t",
		resize_mode = "r",
		fullscreen_toggle = "shift+f",
		layout_stacking = "shift+s",
		layout_tabbed = "shift+w",
		layout_toggle_split = "shift+e",
		focus_left = "h",
		focus_down = "j",
		focus_up = "k",
		focus_right = "l",
